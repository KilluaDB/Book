...
\begin{xltabular}{\textwidth}{|c|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|c|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|c|}
    \hline
...
\subsection{Activity Diagrams}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/register_activity_diagram.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/login_activity_diagram.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/login_with_gmail_activity.png}
   ...
   \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/23.Create_Project.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/24.Delete_Database.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/4.Create_Table.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/5.Delete_table.png}
    ...
    % \begin{figure}[H]
    %     \centering
    %     \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/6.Edit_Table.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/19.Add_Column.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/20.Drop_Column.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/21.Create_Index.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/22.Drop_Index.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/1.Insert_Row.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/2.Delete_Row.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/3.Edit_Row.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/7.Execute_Query_from_Query_Editor.png}
    ...
    % \begin{figure}[H]
    %     \centering
    %     \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/8.Execute_Query_via_Text2SQL_AI_Service.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/9.Create_Schema_via_Text2Schema_AI_Service.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/10.Create_collection.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/11.Delete_Collection.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/13.Create_Document.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/14.Delete_Document.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/15.Add_a_Field_in_a_Document.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/16.Delete_a_Field_in_a_Document.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/17.Update_a_Field_in_a_Document.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/activity/18.Filter_Tab_Data_Retrieval.png}
