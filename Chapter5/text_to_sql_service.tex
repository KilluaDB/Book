...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/ai/text2SQL2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/ai/Selector2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/ai/Decomposer2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/ai/Reviewer2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{images/ai/Refiner2.jpg}
    \caption{The Refiner}
